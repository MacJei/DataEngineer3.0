...
schema = avro.schema.Parse(open("/apps/divolte/divolte-collector-0.9.0/conf/MyEventRecord.avsc").read())
...
c = Consumer({'bootstrap.servers': '35.204.145.90:6667', 'group.id': "my-group", 'auto.offset.reset': 'latest', "enable.auto.commit": True})
...
while running:
    ...
    if not msg.error():
        ...
        df.to_sql('t_store_py', engine, if_exists='append')
